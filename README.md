...
Rate limits (without user account):

- 20 requests per windowMs with a window of 60 seconds per IP-Address per route

Rate limits (with user account):

- 40 requests per windowMs with a window of 60 seconds per IP-Address per route
